...
use test_stronghold::get_address_with_funds;
...
const API_ENDPOINT: &str = "http://18.203.223.38:14265";

// The faucet endpoint allows requesting funds for testing purposes.
const FAUCET_ENDPOINT: &str = "http://18.203.223.38:8091/api/enqueue";
